...
import logo1 from "../../assets/service3/logo3.svg";
import bg from "../../assets/service1/texture.png";
import arrow from "../../assets/Arroup.svg";
import blob from "../../assets/service3/top.svg";
import blob2 from "../../assets/service3/bottom.svg";
...
const Card3rd = () => {
    return (
      <div className="relative p-6 rounded-xl bg-black text-white overflow-hidden h-[300px] lg:w-[286px] transition-all hover:shadow-lg md:mt-16">
        {/* Background Pattern */}
        <Image
          src={bg}
