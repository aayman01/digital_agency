...
import logo1 from "../../assets/service4/logo4.svg";
import bg from "../../assets/service1/texture.png";
import arrow from "../../assets/Arroup.svg";
import blob from "../../assets/service4/top.svg";
import blob2 from "../../assets/service4/bottom.svg";
...
const Card4th = () => {
    return (
      <div className="relative p-6 rounded-xl bg-black text-white overflow-hidden h-[300px] lg:w-[286px] transition-all hover:shadow-lg">
        {/* Background Pattern */}
        <Image
          src={bg}
