...
const RecentWorks = () => {
    ...
    return (
      <section className="relative text-white px-4 lg:px-28">
        {/* First Row */}
        <div className="relative z-10 flex flex-wrap justify-between md:gap-2 lg:gap-5 mb-8">
        ...
        {/* Second Row */}
        <div className="z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-5">
